...
import { Grid, Paper, Avatar, Typography, TextField, Button, MenuItem } from '@material-ui/core'
...
const AddPatient = () => {
    const paperStyle = { padding: 20, width: 300, margin: "0 auto", backgroundColor: "rgba(239, 237, 236, 0.5)", boxShadow: "1px 5px 10px black" }
    ...
    const validate = (e) => {
        ...
        if (PatientPhone === "") {
            ...
            if (isNaN(Number(PatientPhone)) && PatientPhone.length === 10) {
                i = 0;
        ...
        if (i === 1) {
            var DateOfBirth = String(PatientDateOfBirth.getDate()) + "-" + String(parseInt(PatientDateOfBirth.getMonth()) + 1) + "-" + String(PatientDateOfBirth.getFullYear());
            const Data = { PatientName, PatientPhone, Address, gender, DateOfBirth, bloodGroup, Disease }
